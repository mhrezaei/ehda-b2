    ...
    <div class="row mt15 mb20">
                ...
                <div class="item" dir="rtl">
                    <a href="#" target="_blank">
                        ...
                        <div class="slide-text">
                            <h4>«این لحظه خوش را از تو دارم»</h4>
                ...
                <div class="item" dir="rtl">
                    <a href="#" target="_blank">
                        ...
                        <div class="slide-text">
                            <h4>«این لحظه خوش را از تو دارم»</h4>
                            <span>
                                بهرام فرهادی ۳۸ ساله - گیرنده ریه بهرام فرهادی ۳۸ ساله - گیرنده ریه بهرام فرهادی ۳۸ ساله - گیرنده ریه بهرام فرهادی ۳۸ ساله - گیرنده ریه
                            </span>
                        </div>
                    </a>
                </div>
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <div class="media-list">
                @for($i = 0; $i < 6; $i++)
                    <div class="media-list-item border-right-green">
                        <a href="#">
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <div class="media-list">
                @for($i = 0; $i < 6; $i++)
                    <div class="media-list-item border-right-blue">
                        <a href="#">
                            <div class="media-list-item-image">
                                <img src="data:image/svg+xml;base64,"
                                     class="media-object">
